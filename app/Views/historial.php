...
<div class="container">
    <h1 class="mt-4 mb-4">Historial de la Noticia</h1>
            ...
            <?php foreach ($historial as $historia): ?>
                <tr>
                    ...
                    <td>
                        ...
                        $userId = $historia['id_usuario'];
                        $sqlUsuario = "SELECT nombre FROM usuarios WHERE id = ?";
                        $queryUsuario = $db->query($sqlUsuario, [$userId]);
                        $usuario = $queryUsuario->getRow()->nombre;
                        echo $usuario;
                        ?>
                    </td>
                    <td>
                        ...
                        // Consulta SQL para obtener el nombre del usuario
                        $userId = $historia['id_usuario'];
                        $sqlUsuario = "SELECT email FROM usuarios WHERE id = ?";
                        $queryUsuario = $db->query($sqlUsuario, [$userId]);
                        $usuario = $queryUsuario->getRow()->email;
                        echo $usuario;
                        ?>
                    </td>
                </tr>
