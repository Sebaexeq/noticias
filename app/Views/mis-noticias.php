...
<div class="container">
  ...
  <table class="table">
    ...
    <tbody>
        ...
        // Consulta SQL para obtener las noticias del usuario actual
        $userId = session()->get('id');
        $sql = "SELECT * FROM noticias WHERE id_usuario = ?";
        ...
        foreach ($noticias as $noticia): ?>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('historial?id=' . $noticia['id']) ?>">Ver Historial</a> <!-- Enlace al historial -->
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
